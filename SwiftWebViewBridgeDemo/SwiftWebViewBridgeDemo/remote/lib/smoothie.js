...
SmoothieChart.prototype.render = function(canvas, time) {
	...
	for (var d = 0; d < this.seriesSet.length; d++) {
		...
		if (dataSet.length > 1) {
			...
			if (seriesOptions.fillLinearGradient) {
				// Create gradient
				var fillLinearGradient = context.createLinearGradient(0, dimensions.height, dimensions.width, dimensions.height);
				fillLinearGradient.addColorStop(0, seriesOptions.fillLinearGradient[0]);
				fillLinearGradient.addColorStop(1, seriesOptions.fillLinearGradient[1]);
				context.lineTo(dimensions.width + seriesOptions.lineWidth + 1, lastY);
				context.lineTo(dimensions.width + seriesOptions.lineWidth + 1, dimensions.height + seriesOptions.lineWidth + 1);
				context.lineTo(firstX, dimensions.height + seriesOptions.lineWidth);
				context.fillStyle = fillLinearGradient;
				context.fill();
			}
			if(seriesOptions.strokeLinearGradient){
				var strokeLinearGradient = context.createLinearGradient(0, dimensions.height, dimensions.width, dimensions.height);
				strokeLinearGradient.addColorStop(0, seriesOptions.strokeLinearGradient[0]);
				strokeLinearGradient.addColorStop(1, seriesOptions.strokeLinearGradient[1]);
				context.strokeStyle = strokeLinearGradient
				context.stroke();
			}
